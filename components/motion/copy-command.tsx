...
export function CopyCommand({ command, className }: CopyCommandProps) {
  ...
  return (
    ...
    >
      ...
      <span className="flex size-7 shrink-0 items-center justify-center rounded-full bg-white/10 text-white/60 transition-colors group-hover:bg-white/20 group-hover:text-white">
